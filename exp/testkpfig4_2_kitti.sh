...
#test_name="sample"
test_name="learnDesc_1key_256"
#test_name="not100lr3jit"
kitti_res_dir="./kitti_test_results/${test_name}" 
...
do 
    ...
    python inference.py --randomize_points  --model='3DFeatNet2' --data_dir=${data_dir} --use_keypoints_from=${kp_dir} --output_dir=${res_dir} --checkpoint=./ckpt/${test_name}/ckpt/checkpoint.ckpt-72500
