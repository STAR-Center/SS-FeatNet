...
root_dir="/home/yijun/Documents/roboGit/3dfnv/data/3dmatch/data_bin/"
...
do 
    ...
    python inference.py  --model='3DfeatNet23D' --base_scale=0.186 --data_dir=${data_dir} --use_keypoints_from=${kp_dir} --output_dir=${res_dir} --checkpoint=./ckpt/${test_name}/ckpt/checkpoint.ckpt-136500
done
#72500
