...
RESULT_FOLDER = '../3dfeatnetkp_test_results/sample/';
%DATA_PAIRS = {'452', '454'};
%DATA_PAIRS = {'183', '637'};             
DATA_PAIRS = {'644', '180'};

%DATA_FOLDER='../data/kitti/00/';
%RESULT_FOLDER = '../3dfeatnetkp_kitti_test_results/learnDesc_1key_3df_256/00/';
%DATA_PAIRS = {'000022', '000032'};

%DATA_FOLDER='../data/kitti/01/';
%RESULT_FOLDER = '../kitti_test_results/sample/01/';
%DATA_PAIRS = {'000400', '000403'};

%DATA_FOLDER='../data/kitti/01/';
%RESULT_FOLDER = '../kitti_test_results/learnDesc_1key_256/01/';
%DATA_PAIRS = {'000400', '000403'};
